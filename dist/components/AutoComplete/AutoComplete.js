...
export var AutoComplete = function (props) {
    var fetchSuggestions = props.fetchSuggestions, onSelect = props.onSelect, value = props.value, renderOption = props.renderOption, style = props.style, restProps = __rest(props, ["fetchSuggestions", "onSelect", "value", "renderOption", "style"]);
    ...
    var generateDropdown = function () {
        return (React.createElement(Transition, { in: showDropdown || loading, animation: "zoom-in-top", timeout: 300, onExited: function () { setSugestions([]); } },
            React.createElement("ul", { className: "kip-suggestion-list" },
                loading &&
    ...
    return (React.createElement("div", { className: "kip-auto-complete", style: style, ref: componentRef },
