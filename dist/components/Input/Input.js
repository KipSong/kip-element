...
export var Input = function (props) {
    ...
    var className = classNames('kip-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: className, style: style },
        prepend && React.createElement("div", { className: 'kip-input-group-prepend' }, prepend),
        icon && React.createElement("div", { className: 'icon-wrapper' },
            React.createElement(Icon, { title: "title-" + icon, icon: icon })),
        React.createElement("input", __assign({ className: 'kip-input-inner', disabled: disabled }, restProps)),
        append && React.createElement("div", { className: 'kip-input-group-append' }, append)));
};
