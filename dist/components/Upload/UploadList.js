...
var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'kip-upload-list' }, fileList.map(function (item) {
        return (React.createElement("li", { className: 'kip-upload-list-item', key: item.uid },
